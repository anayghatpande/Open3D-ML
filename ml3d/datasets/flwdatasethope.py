...
class FLWDATASETHOPE(BaseDataset):
    ...
    def get_split(self, split):
        ...
        """
        return FLWDATASETHOPESplit(self, split=split)
...
class FLWDATASETHOPESplit(BaseDatasetSplit):
...
DATASET._register_module(FLWDATASETHOPE)
